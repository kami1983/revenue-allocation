...
async function main() {
  ...
  const assign_account = '0x892d3bEd1855b7D05606acaA479BBA0832A85111'
  ...
  const vault_proxy = await upgrades.deployProxy(EcoVault, [distribution_address, assign_account], { initializer: 'initialize' });
