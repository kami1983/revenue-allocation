// add SafeMathUpgradeable and ReentrancyGuardUpgradeable
...
async function main() {
  ...
  console.log('Support sigin account')
  // 
  ...
  const new_dividend_distribution = await upgrades.upgradeProxy(distribution_address, EcoDividendDistribution, { initializer: 'initialize_111', args: [] });
  ...
  console.log('vault upgrade success of DividendDistribution! 1.1.1, implementation_address - ', implementation_address);
